...
const icon = divIcon({
  ...
  html: `<div style="width:40px;height:40px;position:relative;">
    ...
    <div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:30px;height:30px;border-radius:50%;background:#0d6b6e;border:3px solid #fffdf8;box-shadow:0 2px 3px rgba(0,0,0,.3);display:flex;align-items:center;justify-content:center;">
